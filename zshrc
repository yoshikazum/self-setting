...
manpath=($X11HOME/man /usr/man /usr/share/man  /usr/share/man/ja)
export MANPATH

#path=(~/bin /sbin /usr/sbin/ /usr/share/sbin $PATH)
#export PATH

# Hosts to use for completion (see later zstyle)
hosts=(`hostname` ohashi-lab.bio.kyutech.ac.jp)
...
watch=(notme)                   # watch for everybody b  ut me
